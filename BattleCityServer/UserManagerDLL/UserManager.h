...
public:
    ...
    bool UserExists(const std::string& username, std::string& errorMessage);
    bool RegisterWeapon(const std::string& username, double bulletSpeed, double reloadTime, std::string& errorMessage);
